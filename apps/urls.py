...
from apps.views import (
    ...
    RequestTemplateView, ConcursTemplateView, TolovTemplateView, DiagramsTemplateView, StreamStatisticsListView
)
...
urlpatterns = [
    ...
    path('admin_page/diagrams', DiagramsTemplateView.as_view(), name='diagrams_page'),
